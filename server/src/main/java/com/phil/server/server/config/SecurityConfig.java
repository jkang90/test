package com.phil.server.server.config;
import com.phil.server.server.service.UserService;
import com.phil.server.server.util.JwtRequestFilter;
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/users/login", "/user/signup").permitAll()
                .antMatchers("/shipment/**").authenticated()
                .and()
                .httpBasic();
